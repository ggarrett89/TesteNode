...
pipeline {
    ...
    parameters {
        string(name: 'teste', defaultValue: 'terraform', description: 'Workspace/teste file to use for deployment')
    ...
    stages {
        ...
        stage('Plan') {
            steps {
                ...
                sh 'pwd;cd terraform/aws-instance-first-script ; terraform workspace new ${teste}'
                sh 'pwd;cd terraform/aws-instance-first-script ; terraform workspace select ${teste}'
